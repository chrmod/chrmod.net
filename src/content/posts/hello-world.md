---
title: "hello world"
description: "First post. The accidental origin story of chrmod.net — Hugo, GitHub Pages, and a screenshot Reddit refused to take."
date: 2016-05-29
tags: ["meta"]
readTime: "3 min read"
draft: false
...
OK. There are many free image hostings, most people on unixporn use imgur.com, but that would be too easy. Instead I decided to finally kick off my own website in a form of a blog. After 24 hours, here we are.
...
The obvious way to go was to use some kind of static page generator and host it on GitHub as apparently we're able to use for free for personal stuff.
...
![gruvbox theme for i3wm, vim and tmux](/hello-world/desktop-screenshot-2016-05-29.png)
